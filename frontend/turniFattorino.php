...
?>
  ...
  <?php include "../common/headerFattorino.php";
    ...
    if ($_SESSION["logged"] != true){
      ...
      $res = queryTurniFattorino($cid, $email); 
          ...
          <?php 
            ...
            <div class = "overlay" id = "modifica">
              <div class = "wrapper">
                ...
                <div class = "content">
                  <div class = "container">
                  <form method="GET" action="../backend/checkAggiornamentoOrariFattorino.php">
            ...
            <div class = "overlay" id = "rimuovi">
              <div class = "wrapper">
                ...
                <div class = "content">
                  <div class = "container">
                  <form method="GET" action="../backend/checkRimozioneTurnoFattorino.php">
                      <label for="giono">Giorno:</label>
                      <select name="giorno" id="giorno">
                        <option value="lunedì">lunedì</option>
                        <option value="martedì">martedì</option>
